    ...
    def greedy_algolithm(self,current_location, packages_array):
        ...
        for i in packages_array:
            ...
            if cureent_location_index < package_address_index:
                compared_distance = float(self.distance_table.search(i)[cureent_location_index])
                ...
                compared_distance = float(self.distance_table.search(current_location)[package_address_index])
                if compared_distance < next_location_distance:
                    next_location = i
                    next_location_distance = compared_distance
...
# def greedy_algolithm(packages_array):
#     distance_hash_table , address_indexes_table = init_distance_table()
